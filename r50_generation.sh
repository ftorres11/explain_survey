...
# Grad-CAM
python cam_generation.py --batch_size 10 --model resnet50 --method gradcam --store_dir SaliencyMaps/ImageNet/ResNet50/Res_4 --use_gpu  --path_data data/50k_sorted.csv
